...
1. Fork https://github.com/vlang/vgura using GitHub's interface to your own account.
   Let's say that the forked repository is at
   `https://github.com/YOUR_GITHUB_USERNAME/v` .
2. Clone the main vgura repository https://github.com/vlang/vgura to a local folder on
   your computer, say named vgura/ (`git clone https://github.com/vlang/vgura vgura`)
3. `cd vgura`
...
9. If there are merge conflicts, or a branch lags too much behind vgura's main,
...
The point of doing the above steps, is to never directly push to the main vgura
repository, _only to your own fork_. Since your local `main` branch tracks the
main vgura repository's main, then `git checkout main`, as well as
